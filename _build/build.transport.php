...
define('PKG_NAME','BrowserServe');
define('PKG_NAME_LOWER','browserserve');
define('PKG_VERSION','1.0');
define('PKG_RELEASE','beta');
define('PKG_CATEGORY','BrowserServe');
...
$sources= array (
    ...
    'docs' => $root . 'core/components/browserserve/docs/',
...
/* This section transfers every file in the local
 browserserves/browserserve/assets directory to the
 target site's assets/browserserve directory on install.
...
/* This section transfers every file in the local 
 browserserves/browserserve/core directory to the
 target site's core/browserserve directory on install.
